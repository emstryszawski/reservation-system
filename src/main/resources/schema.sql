...
INSERT INTO USER(ID, NAME, ROLE_ID, BLOCKED) VALUES(1, 'PC1', 2, FALSE);
INSERT INTO USER(ID, NAME, ROLE_ID, BLOCKED) VALUES(4, 'PC2', 2, FALSE);
INSERT INTO USER(ID, NAME, ROLE_ID, BLOCKED) VALUES(2, 'SA1', 3, FALSE);
INSERT INTO USER(ID, NAME, ROLE_ID, BLOCKED) VALUES(3, 'USR1', 1, FALSE);

INSERT INTO OFFER(ID, DESCRIPTION, NAME, OWNER_ID)
VALUES
    (1, 'OFERERERE', 'HOTEL', 1),
    (2, '7D67SDF', 'RESTURACJA', 2);
